...
export default function Dashboard({ items }) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 mb-4 w-full">
      <div className="glass-panel px-2.5 py-2 flex items-center justify-center gap-2 min-w-0">
      ...
      <div className="glass-panel px-2.5 py-2 flex items-center justify-center gap-2 min-w-0 border-gold/20">
